        ...
        <div class="main-content">
            ...
            ">
                <el-aside v-if="menu.showSider" width="152px">
                    <shippingQueryMenu></shippingQueryMenu>
                </el-aside>
                <el-main class="view">
...
export default defineComponent({
    ...
    setup() {
        ...
        if (agent != null) {
            agent.ipcRequest("shippingQuery/setViewType", "normal");
        }

        function windowOpt(opt) {
            agent.ipcRequest("shippingQuery/opt", opt);
        }

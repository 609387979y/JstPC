<template>
  <div class="main-container">
    ...
    <div class="main-content">
      <el-container style="height: 100%" v-if="
...
import boxTrackMenu from "@/components/menu/boxTrackMenu.vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    if (agent != null) {
      agent.ipcRequest("boxTrack/setViewType", "normal");
    }

    function windowOpt(opt) {
      agent.ipcRequest("boxTrack/opt", opt);
    }

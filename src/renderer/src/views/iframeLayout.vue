    ...
    <div class="main-container">
        <div class="header">
            <div class="left">
                ...
                <div style="margin-left:15px">航线轨迹</div>
            </div>
        ...
        <div class="view-content">
            <div v-html="iframe" style="width:100%;height:100%"></div>
        </div>
    </div>
</template>
...
export default defineComponent({
    ...
    setup() {
        ...
        if (agent != null) {
            agent.ipcRequest("iframe/setViewType", "normal");
        }

        function windowOpt(opt) {
            agent.ipcRequest("iframe/opt", opt);
        }
        let iframe = ref('');
        function init() {
            console.log(route.query.iframe);
            iframe.value = deCode(route.query.iframe);
        }

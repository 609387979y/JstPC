    ...
    <div class="header">
      ...
      <div class="right">
        ...
        <div class="user-info-menu">
          <div class="top-menu">
            <el-tabs v-model="topMenu.currentMenu" class="top-menu-tabs" @tab-click="topMenu.switchMenu">
              <el-tab-pane label="舱单发送" name="manifest"></el-tab-pane>
              <el-tab-pane label="VGM发送" name="vgm"></el-tab-pane>
            </el-tabs>
    ...
    <div class="main-content">
      ...
      <el-container style="height: 100%">
        <el-aside v-if="menu.showSider" width="152px">
          <ManifestMenu v-if="topMenu.currentMenu === 'manifest'"></ManifestMenu>
          <ManifestVGMMenu v-else></ManifestVGMMenu>
...
import ManifestMenu from "@/components/menu/ManifestMenu.vue";
import ManifestVGMMenu from "@/components/menu/ManifestVGMMenu.vue";
...
export default defineComponent({
  ...
  setup() {
    ...
    if (agent != null) {
      agent.ipcRequest("manifest/setViewType", "normal");
    }

    function windowOpt(opt) {
      agent.ipcRequest("manifest/opt", opt);
    }
...
$header-height: 51px;
$manifest-bgcolor: #8DCE6C;

.header {
  height: $header-height;
  color: #fff;
  box-shadow: 0 1px 0 0 #85B02B;
  display: flex;

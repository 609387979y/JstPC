...
export default defineComponent({
  ...
  setup() {
    ...
    async function getList() {
      ...
      let res = await request.get("/api/CargoEDISHManifestDraft/GetList", {
    ...
    async function copyAndCreate(id, gotoEdit) {
      let res = await request.post(
        "/api/CargoEDISHManifestDraft/CopyFromOtherDraft",
        {
          copyId: id,
        }
      );
    ...
    async function exportexcel() {
      ...
      agent?.ipcRequest(
        ...
        import.meta.env.VITE_AXIOS_HOST +
          "/api/CargoEDISHManifestDraft/ExportManifest?id=" +
    ...
    async function deleteDraft(id) {
      ...
      let res = await request.post(
        "/api/CargoEDISHManifestDraft/DeleteDraftList",
        {
          idList: ids,
        }
      );

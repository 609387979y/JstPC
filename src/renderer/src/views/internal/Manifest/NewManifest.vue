<template>
    <div class="manifest-content">
        ...
        <ManifestPreviewDialog ref="previewDialog" @btnclick="btnfunction"></ManifestPreviewDialog>
...
export default defineComponent({
    ...
    methods: {
        ...
        async saveDraft() {
            ...
            this.$message.success('成功');
            // 跳转界面
            this.$router.push("/manifest/Nrafts")
    ...
    mounted() {
        // this.$http.get("/api/CargoEDISFTTemp/GetList")
    }
